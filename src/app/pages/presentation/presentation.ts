...
export class PresentationComponent {
  readonly formations = [
    ...
    },
    {
      ...
      desc: 'Découvrez les propriétés des plantes médicinales et leurs applications thérapeutiques.',
    ...
    },
    {
      ...
      desc: 'Formation complète aux techniques traditionnelles de ventouses thérapeutiques.',
      items: ['Histoire et principes', 'Types de ventouses', 'Protocoles de pratique', 'Hygiène et sécurité', 'Mise en situation'],
      keywords: 'hijama cupping ventouses formation thérapeutique traditionnelle',
    },
    {
      emoji: '🌿', id: '2',
      title: 'Détox Thérapeutique Complète',
      ...
      keywords: 'détox thérapeutique émonctoires perte de poids formation bien-être',
    },
    {
      emoji: '🥗', id: '1',
      ...
      keywords: 'nutrition thérapeutique pathologies formation diététique accompagnement',
    },
  ];
