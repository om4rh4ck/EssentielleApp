...
courses.push(
  ...
  {
    id: '11',
    title: 'Herboristerie & plantes medicinales',
    instructorId: '2',
    modules: 8,
    students: 83,
    thumbnail: '/formation%20herboristerie%20phytoth%C3%A9rapie/cover%20.jpeg',
    description: 'Développez une pratique structurée autour des plantes médicinales, des synergies naturelles et des bases de l’usage des plantes appliquées.',
    presentation: "Bienvenue dans la formation Herboristerie & plantes medicinales. Ce parcours vous guide pas à pas dans l'univers des plantes medicinales, des preparations naturelles et de l'accompagnement bien-etre. Vous decouvrirez les fondamentaux de la botanique, les usages traditionnels des plantes, les formes galeniques et les bonnes pratiques pour proposer un conseil professionnel et securise.",
    ...
    objectives: [
      "Comprendre les bases de l'herboristerie et des plantes medicinales",
    ...
    moduleItems: [
      {
        id: 'module-11-pdf',
        title: 'Formation Herboristerie & plantes medicinales',
        pdfName: 'Herboristerie plantes medicinales.pdf',
    ...
    quizTitle: "Examen Final — Formation Professionnelle en Herboristerie & Plantes medicinales",
    quizAttemptsRemaining: 2,
    quizQuestions: [
      { id: 'herb-q1',  prompt: "Quelle est la définition principale de l'usage des plantes médicinales ?", options: ["Utilisation des huiles essentielles uniquement", "Utilisation des plantes médicinales pour la santé", "Utilisation des minéraux naturels", "Utilisation des médicaments chimiques"], correctIndex: 1 },
      ...
      { id: 'herb-q10', prompt: "La synergie des plantes signifie :", options: ["Opposition des plantes", "Effet neutre", "Effet combiné renforcé", "Effet toxique"], correctIndex: 2 },
  ...
  },
  {
    ...
    quizTitle: "Examen Final — Formation Hijama & Cupping",
    quizQuestions: [
      {
        id: "hijama-q1",
