...
const courses: Course[] = [
  {
    ...
    contentItems: [
      ...
      { id: 'content-1-4', text: 'Examen final — 30 questions noté sur 10' },
  ...
  },
  {
    ...
    contentItems: [
      ...
      { id: 'content-2-2', text: 'Détox émonctoires (foie, reins, intestins, poumons, peau)' },
      { id: 'content-2-3', text: 'Détox peau' },
      { id: 'content-2-4', text: '10 modules complets — détox thérapeutique intégrale' },
      { id: 'content-2-5', text: 'Alimentation détox et batch cooking' },
      { id: 'content-2-6', text: "PDF de formation complet téléchargeable" },
...
courses.push(
  {
    ...
    contentItems: [
      ...
      { id: 'content-5-4', text: 'Certificat de validation à la fin de la formation' },
    ],
    moduleItems: [],
  },
  {
    ...
    status: 'published',
    contentItems: [
      { id: 'content-6-1', text: 'Approche musculaire' },
      { id: 'content-6-2', text: 'Mobilité et articulation' },
      { id: 'content-6-3', text: 'Techniques de rééquilibrage' },
      { id: 'content-6-4', text: 'Certificat de validation à la fin de la formation' },
    ],
    moduleItems: [],
  },
  {
    ...
    modules: 6,
    students: 92,
    thumbnail: '/uploads/massage-visage-cover.jpeg',
    ...
    contentItems: [
      ...
      { id: 'content-7-2', text: 'Techniques jeunesse et éclat du visage' },
      { id: 'content-7-3', text: 'Relaxation et tonicité du visage' },
      { id: 'content-7-4', text: 'Certificat de validation à la fin de la formation' },
    ],
    moduleItems: [],
  },
  {
    ...
    modules: 10,
    students: 76,
    thumbnail: '/uploads/drainage-lymphatique-cover.jpeg',
  ...
  },
  {
    ...
    modules: 12,
    students: 38,
    thumbnail: '/uploads/soins-infirmiers-cover.jpeg',
    ...
    status: 'published',
    contentItems: [
      { id: 'content-9-1', text: 'Changement de pansement' },
      { id: 'content-9-2', text: 'Techniques de suture' },
      { id: 'content-9-3', text: 'Pose et gestion de perfusion' },
      { id: 'content-9-4', text: 'Soins de base et hygiène' },
      { id: 'content-9-5', text: 'Certificat de validation à la fin de la formation' },
    ],
    moduleItems: [],
  },
  {
    ...
    status: 'published',
    contentItems: [
      { id: 'content-10-1', text: 'Accompagnement quotidien' },
      { id: 'content-10-2', text: 'Hygiène et confort' },
      { id: 'content-10-3', text: 'Assistance et bien-être' },
      { id: 'content-10-4', text: 'Relation d\'aide et communication' },
      { id: 'content-10-5', text: 'Certificat de validation à la fin de la formation' },
    ],
    moduleItems: [],
  },
  {
    ...
    description: 'Développez une pratique structurée autour des plantes, des synergies naturelles et des bases de la phytothérapie appliquée.',
    access: 'paid',
    priceEur: 990,
    priceMinEur: 990,
    priceMaxEur: 3500,
    ...
    status: 'published',
    contentItems: [
      { id: 'content-11-1', text: 'Les plantes et leurs bienfaits' },
      { id: 'content-11-2', text: 'Utilisation traditionnelle des plantes' },
      { id: 'content-11-3', text: 'Préparations naturelles et conseils bien-être' },
      { id: 'content-11-4', text: 'Certificat de validation à la fin de la formation' },
    ],
    moduleItems: [],
  },
  {
    ...
    modules: 10,
    students: 69,
    thumbnail: '/uploads/hijama-im1.jpeg',
    ...
    contentItems: [
      { id: 'content-12-1', text: '10 modules complets — ventouses sèches, mobiles et bien-être' },
      { id: 'content-12-2', text: 'PDF de formation complet téléchargeable' },
      { id: 'content-12-3', text: 'Galerie illustrée — 5 visuels pédagogiques' },
      { id: 'content-12-4', text: 'Protocoles ciblés : dorsales, jambes lourdes, fatigue, anti-stress' },
      { id: 'content-12-5', text: 'Études de cas cliniques pratiques (3 cas)' },
      { id: 'content-12-6', text: 'Certificat de validation à la fin de la formation' },
    ],
    galleryImages: [
      '/uploads/hijama-im1.jpeg',
