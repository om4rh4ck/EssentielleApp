...
courses.push(
  ...
  },
  {
    ...
    status: 'published',
    contentItems: [
      { id: 'content-11-1', text: 'Botanique' },
      { id: 'content-11-2', text: 'Plantes médicinales' },
      { id: 'content-11-3', text: 'Préparations naturelles' },
      { id: 'content-11-4', text: 'Tisanes et macérations' },
      { id: 'content-11-5', text: 'Conseils bien-être' },
      { id: 'content-11-6', text: 'Certificat professionnel de fin de formation' },
    ],
    moduleItems: [],
  },
  {
